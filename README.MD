...
### Exception Types
- [`CancelEnqueueMessageException`](ChannelFactory/CancelEnqueueMessageException.cs) - User or channel cancellation during enqueue
...
## Support
- [GitHub Issues](https://github.com/potapich1978/EventFlowChannel/issues)
